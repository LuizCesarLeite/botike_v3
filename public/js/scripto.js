...
const pauseImage = "http://127.0.0.1:3000/api/v1/bots/test/media/typo.png"
...
// Template dos retorno file imagens
...
const pegaMensagemBPInsertaTemplate = async () => {
  const uri = "http://localhost:8080/falauser/";
